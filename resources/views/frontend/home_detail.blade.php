...
<html lang="en">
  ...
  <div class="site-wrap">
            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <div class="row no-gutters mt-5">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_1.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_1.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_2.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_2.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_3.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_3.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_4.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_4.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_5.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_5.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_6.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_6.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_7.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_7.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_8.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_8.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <a href="images/img_1.jpg" class="image-popup gal-item"><img src="{{ asset('assets/images/img_1.jpg') }}" alt="Image" class="img-fluid"></a>
                </div>
    ...
    <div class="pb-0 site-section site-section-sm bg-light">
      <div class="container">
